...
export const pow = (mp: Mp, self: null, args: PapyrusValue[]): number =>
	Math.pow(getNumber(args, 0), getNumber(args, 1));
...
export const floor = (mp: Mp, self: null, args: PapyrusValue[]): number =>
	Math.floor(getNumber(args, 0));

export const ceil = (mp: Mp, self: null, args: PapyrusValue[]): number =>
	Math.ceil(getNumber(args, 0));
