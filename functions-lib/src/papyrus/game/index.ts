...
import { getServerOptionsValue } from './server-options';
...
export const register = (mp: Mp): void => {
  ...
  mp.registerPapyrusFunction('global', 'GameEx', 'GetServerOptionsString', (self, args) =>
    getServerOptionsValue(mp, args)
  );
  mp.registerPapyrusFunction('global', 'GameEx', 'GetServerOptionsStringArray', (self, args) =>
    getServerOptionsValue(mp, args)
  );
  mp.registerPapyrusFunction('global', 'GameEx', 'GetServerOptionsInt', (self, args) => getServerOptionsValue(mp, args));
  ...
  mp.registerPapyrusFunction('global', 'GameEx', 'GetServerOptionsBool', (self, args) => getServerOptionsValue(mp, args));
};
