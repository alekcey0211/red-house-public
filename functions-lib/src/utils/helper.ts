...
export const uint8 = (buffer: ArrayBufferLike, offset: number) => new DataView(buffer).getUint8(offset);
export const uint16 = (buffer: ArrayBufferLike, offset: number) => new DataView(buffer).getUint16(offset, true);
export const uint32 = (buffer: ArrayBufferLike, offset: number) => new DataView(buffer).getUint32(offset, true);
export const int32 = (buffer: ArrayBufferLike, offset: number) => new DataView(buffer).getInt32(offset, true);
export const float32 = (buffer: ArrayBufferLike, offset: number) => new DataView(buffer).getFloat32(offset, true);