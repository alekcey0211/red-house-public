...
const setScale = (ctx: Ctx<{ lastScale: number | undefined }, number | undefined>) => {
...
export const register = (mp: Mp): void => {
	...
	mp.makeProperty('scale', {
		isVisibleByOwner: true,
		isVisibleByNeighbors: true,
		updateOwner: new FunctionInfo(setScale).tryCatch(),
		updateNeighbor: new FunctionInfo(setScale).tryCatch(),
	});
};
