...
import { updateAttributeCommon } from './attributes-func';
...
export const register = (mp: Mp) => {
  ...
  actorValues = {
    ...
    setDefaults: (formId: number, options: DefaultOptions, base: Partial<Record<AttrAll, number>> = {}) => {
      const force = options && options.force;
      // console.log('setDefaults', formId, options, base);
